        ...
        class ClientsController < ApplicationController
            ...
            def create
                ...
                if client.save
                    ...
                    render json:{status: 'ERROR', message: 'Failed to add client', data: client.err}, status: :unprocessable_entity
                end
            end
            ...
            def update
                ...
                if client.update(client_params)
                    ...
                    render json:{status: 'ERROR', message: 'Client can not be updated', data: client}, status: :unprocessable_entity
                end
            end
